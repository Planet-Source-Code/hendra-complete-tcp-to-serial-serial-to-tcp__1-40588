...
Private Sub MSComm1_OnComm()
    ...
    Select Case MSComm1.CommEvent
        Case comEvReceive
            Dim Buffer As Variant, EndOfString, LenEndOfString, InString As String
...
Private Sub SockListen_ConnectionRequest(ByVal requestID As Long)
    ...
    lblInfo.Caption = "Connected..." & vbCrLf & SockServer.RemoteHostIP
    Exit Sub
